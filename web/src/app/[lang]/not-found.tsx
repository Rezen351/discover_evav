...
// 404 boundary for routes under /[lang]. Must be locale-aware: its strings are
// embedded in the RSC payload of every [lang] page, so hardcoded Indonesian
// would leak into the /en payload. Detect locale from the URL pathname.
