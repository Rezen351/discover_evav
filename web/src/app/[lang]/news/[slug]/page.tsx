...
export async function generateStaticParams() {
  ...
  return dict.news.map((n) => ({ slug: n.slug }));
}
...
export async function generateMetadata({
  ...
  const article = dict.getNewsBySlug(slug);
  if (!article) {
    return {
      title:
        lang === "en"
          ? "Article Not Found | Discover Evav"
          : "Artikel Tidak Ditemukan | Discover Evav",
      description:
        lang === "en"
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        id: `/id/news/${article.slug}`,
        en: `/en/news/${article.slug}`,
        "x-default": `/id/news/${article.slug}`,
      },
    },
    openGraph: {
      title: article.title,
