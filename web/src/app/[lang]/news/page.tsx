...
export async function generateMetadata({
  ...
  return {
    title:
      lang === "en"
        ? "News & Articles — Discover Evav | Kei Islands"
        : "Berita & Artikel — Discover Evav | Kepulauan Kei",
    description:
      lang === "en"
        ? "The latest news and articles about the Kei Islands: the Meti Kei Festival of Wonders, Evav maritime culture, and the economic impact of tourism on local communities in Southeast Maluku."
    ...
    openGraph: {
      title:
        lang === "en"
          ? "News & Articles — Discover Evav"
          : "Berita & Artikel — Discover Evav",
      description:
        lang === "en"
          ? "Stories from above the white sands: the Meti Kei Festival of Wonders, the transformation of maritime tradition, and the welfare of local Kei Island communities."
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            headline:
              lang === "en"
                ? "Kei Islands News & Articles"
                : "Berita & Artikel Kepulauan Kei",
            description:
              lang === "en"
                ? "The latest news and articles about the Kei Islands and the Meti Kei Festival of Wonders."
