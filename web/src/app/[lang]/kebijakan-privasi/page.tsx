...
export async function generateMetadata({
  ...
  return {
    ...
    description:
      lang === "en"
        ? "Simfoni Evav Privacy Policy — how we handle your data while you explore the Kei Islands tourism site."
        : "Kebijakan Privasi Simfoni Evav — bagaimana kami memperlakukan data Anda saat menjelajahi situs pariwisata Kepulauan Kei.",
    keywords:
      lang === "en"
        ? ["Privacy Policy", "Simfoni Evav Privacy", "Data Protection", "PDP Law", "GDPR", "Discover Evav"]
        : ["Kebijakan Privasi", "Privasi Simfoni Evav", "Perlindungan Data", "UU PDP", "GDPR", "Discover Evav"],
    alternates: {
      canonical: "/kebijakan-privasi",
      languages: {
        id: "/id/kebijakan-privasi",
        en: "/en/kebijakan-privasi",
        "x-default": "/id/kebijakan-privasi",
      },
    },
    openGraph: {
      title: lang === "en" ? "Privacy Policy | Simfoni Evav" : "Kebijakan Privasi | Simfoni Evav",
      description:
        lang === "en"
          ? "How Simfoni Evav handles your data: voluntary forms, server logs, interactive map, and local language preferences."
    ...
    twitter: {
      ...
      description:
        lang === "en"
          ? "How Simfoni Evav handles your data as you explore the Kei Islands."
