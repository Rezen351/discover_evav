...
export const heroBudaya = {
  ...
  ariaLabel: "Budaya & Sejarah Kepulauan Kei",
  quote: {
...
// ── String UI bersama (§2.4 / §3 · label section & a11y) ──────────────────────
// Dipindah dari ternary lang di komponen agar tidak bocor bahasa di JSX.
export const cultureCommon = {
  larvul: {
    pillarsHeading: "Tiga Rumpun Nilai",
    pasalHeading: "Tujuh Pasal Sakral",
    pasalIntro:
      "Larvul Ngabal terdiri dari tujuh pasal yang diwariskan lisan. Empat pasal pertama dari hukum Larvul (Nevnev), tiga pasal sisanya dari hukum Ngabal (Hanilit & Hawear Balwirin) — bersatu dalam satu janji leluhur.",
    historicalRoleEyebrow: "Peran Historis",
  },
  ekspresi: {
    swipeHint: "Geser untuk menjelajahi: ",
    tablistLabel: "Daftar ekspresi budaya Kei",
    videoPlay: "Putar video {title}",
    videoPause: "Jeda video {title}",
  },
  audio: {
    playSong: "Putar lagu {title}",
    coverOf: "Sampul {title}",
    playlist: "Playlist",
    mute: "Bisukan suara",
...
export const breather = {
  ...
  ariaLabel: "Jeda napas budaya Kei",
